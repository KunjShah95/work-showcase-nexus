...
const EmployersSection = () => {
  const stats = [
    { value: "40%", label: "Reduction in hiring time", color: "text-green-600 dark:text-green-400" },
    { value: "85%", label: "Candidate quality improvement", color: "text-blue-600 dark:text-blue-400" },
    { value: "60%", label: "Faster screening process", color: "text-purple-600 dark:text-purple-400" },
    { value: "92%", label: "Recruiter satisfaction rate", color: "text-orange-600 dark:text-orange-400" }
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className={`text-4xl font-bold ${stat.color} mb-2 transition-colors duration-300`}>
                    {stat.value}
                  </div>
            ...
            <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-100 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-white w-full sm:w-auto transition-colors duration-200">
              Start Free Trial
            </Button>
          </div>
